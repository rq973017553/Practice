...
public abstract class BaseOrientationEventListener {
     ...
     */
    public BaseOrientationEventListener(Context context) {
     ...
     */
    public BaseOrientationEventListener(Context context, int rate) {
    ...
    class SensorEventListenerImpl implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (magnitude * 4 >= Z*Z) {
                // OneEightyOverPi实际上就是(180.0f/Math.PI)
                // 作用就是把弧度制转成角度制
